    ...
    <div class="container">
        <div class="row justify-content-start">
            <div class="col-xl-9 col-md-10">
                <h1 class="lt-spacing-normal" data-caption-animate="fadeInLeft" data-caption-delay="100" style="color:#cabb13;text-align: center">ePati</h1>
                  <h3 class="lt-spacing-75 offset-top-10 text-transform-uppercase"  style="color: #0d0a0a">Evcil Hayvanlarınızı Mutlu Edin</h3>
